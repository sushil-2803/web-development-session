            ...
            <div class="col-6 text-center">
                <form method="POST" action="login_back.php">
                    <div class="form-group">
                        ...
                        <input class="form-fields mb-3 form-control" type="text" placeholder="Enter your username"
                            name="username" required>
                        <br>
                        <input class="form-fields mb-3 form-control" type="text" placeholder="Enter your password"
                            name="password" required>

                        <input type="hidden" name="Language" value="English">
                        <br>
                        <input class="btn btn-lg" type="submit" value="LOGIN IN NOW" name="login">
                    </div>
                </form>
            </div>
            <div class="col-3"></div>
